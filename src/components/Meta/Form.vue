      ...
      <div style="display: flex;">
        <div style="width: 100%;">
          ...
          <div class="form-row">
            ...
            <input type="datetime-local" name="dataMeta" id="dataMeta" placeholder="dd/mm/aaaa" required v-model="form.dataMeta" />
          </div>
        ...
        <div style="margin-left: 10%;">
          ...
          <div class="buttons" style="margin-top: 6%;">
            ...
            <RouterLink to="/metas" type="submit">Confirmar</RouterLink>
          </div>
        </div>
      </div>
