  ...
  <Layout sidebar>
    <section>
      ...
      <ul class="status-list">
        ...
        <StatusCard title="Rendimentos" value="Total" icon="ph:identification-badge" :total="totalIncome" />
        <StatusCard title="Movimentação" value="Total" icon="ph:user-rectangle" :total="totalOperations + totalIncome" />
      </ul>
